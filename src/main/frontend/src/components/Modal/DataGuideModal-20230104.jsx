...
export default function DataGuideModal({ onCloseModal, modalType }) {
  return (
    <Modal onCloseModal={onCloseModal} modalType={modalType}>
      <div className="modal-overlay bg-transparent">
        {/* <div className="modal-overlay bg-zinc-900 bg-opacity-20"> */}
        <div className="modal-wrapper-middle w-auto">
          <div className="flex flex-col justify-center items-center pl-[1.875rem] pr-3 pt-2 pb-10 bg-brand rounded-default">
            ...
            <div className="w-[40.688rem] text-white m-0 p-0 mr-[0.5rem] bg-brand rounded-default">
              ...
              <p className="text-[0.938rem] font-normal leading-[1.563rem]">
                ...
                실시간 자료’이므로, 자료 오류 및 표출방식에 따라 실제 값과
                다르게 표기될 수 있어요.
              </p>
            </div>
          </div>
